...
const config = {
  ...
  "inlineSchemaHash": "d3aa80fd3246e050a42f5100baba98f90faadd6c0f9dd051ac74210d93ea6bfa",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "generated/cookit-ecommerce-service/@prisma-client-cookit-ecommerce-service",
    "cookit-ecommerce-service/@prisma-client-cookit-ecommerce-service",
  ]
...
path.join(process.cwd(), "generated/cookit-ecommerce-service/@prisma-client-cookit-ecommerce-service/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated/cookit-ecommerce-service/@prisma-client-cookit-ecommerce-service/schema.prisma")
