...
export async function GET(
  ...
  try {
    ...
    const billboard = await prismaStore.billboard.findUnique({
      where: {
...
export async function DELETE(
  ...
  try {
    ...
    const billboard = await prismaStore.billboard.delete({
      where: {
        id: params.billboardId,
      },
    });
...
export async function PATCH(
  ...
  try {
    ...
    const billboard = await prismaStore.billboard.update({
      where: {
        id: params.billboardId,
      },
      data: {
